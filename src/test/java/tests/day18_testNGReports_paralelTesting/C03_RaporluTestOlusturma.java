...
public class C03_RaporluTestOlusturma extends TestBaseRapor {
    ...
    public void test01(){
        extentTest=extentReports.createTest
                ("Dropdown Testi","Dropdown'da istenen element oldugunu test etme");
        ...
        List<String> optionsStringListesi=
                ReusableMethods.getElementsText(optionsElementList);

        extentTest.info("Dropdown menudeki tum option'lar bir list olarak kaydedildi");
        Assert.assertTrue(optionsStringListesi.contains
